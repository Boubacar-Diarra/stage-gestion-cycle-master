...
<body>
    <fieldset>
        <p>Affectation d'un étudiant à un M1 ou à M2.</p>
        <hr>
        <form action="../controllers/AppartenirDatacontroller.php" method="POST" onsubmit="return verifieEtudiantToSemestre(this);" >
