...
<body>
    <fieldset>
        <p>Affectation d'un module à un coordinateur.</p>
        <hr>
        <form action="../controllers/ResponsableDataController.php" method="POST" onsubmit="return verifieModuleToCoordinateur(this);" >
            
            <?php
                include 'insertModule.php';
                include 'insertCoordinateur.php';
            ?>
