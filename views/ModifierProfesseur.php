...
<body>
    <fieldset>
        <p>Modification des infos: professeur.</p>
        <hr>
        <form action="../controllers/ProfesseurDataContoller.php" method="POST" id="professeur" onsubmit="verifieProfesseur(this);" >
            ...
            <div id="form-button">
                ...
                <a href=<?php echo '"http://localhost/gemProp/views/acceuil.php?pageaffiche=professeur&page='.$_GET['page'].'"'; ?>><input id="retour" type="button" name="" value="Retour"></a>
            </div>
        </form>
    </fieldset>
